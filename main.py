...
async def verify_transaction(tx_id: str, user_address: str, ton_amount: float):
    wallet = WalletV4R2(client, mnemonic='worth woman absent fence pattern dirt tiger exhibit repair electric
 estate sadness pledge poverty flower bench penalty emerge stage lonely
 skate advance blouse dust')  # แทนที่ด้วย mnemonic ของทีม
